...
\usepackage[style=verbose,authoryear,backend=biber,natbib=true]{biblatex}
\usepackage{graphicx}

%\usepackage{titlesec}
%\titlespacing*\section{0pt}{12pt plus 4pt minus 2pt}{0pt plus 2pt minus 2pt} % storlek på padding efter \section
%\titlespacing*\subsubsection{0pt}{12pt plus 4pt minus 2pt}{0pt plus 2pt minus 2pt}[style=verbose]
...
\includegraphics[scale=.451]{linnehalv}
